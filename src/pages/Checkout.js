            ...
            <div className="col-7">
              <div className="checkout-left-data">
                ...
                <p className="user-details total-price">
                  Nicholas Developer (nickoklaus5@gmail.com)
                </p>
                ...
                <div className="d-flex gap-10 align-items-center">
                  <div className="w-75 d-flex gap-10 mb-2">
                    <div className="w-25 position-relative">
                      ...
                      <img src={images.watch} alt="shipimage" className="img-fluid"/>
                    </div>
                    <div>
                        <h5 className="total-price">jssasasa</h5>
                        <p className="total-price">s/ #asasasas</p>
                    </div>
                  </div>
                  <div className="flex-grow-1">
