              ...
              <div className="main-product-image">
                <div>
                  ...
                  <ReactImageZoom
                    ...
                    }} // Adjust the zoom lens style as desired
                  />
                </div>
              </div>
            ...
            <div className="col-6">
              <div className="main-product-details">
                <div className="border-bottom">
                  <h3 className="title">
                    Kids Headphones Bulk 10 Pack Multi Colorred For Students
                  </h3>
                </div>
                ...
                <div className="border-bottom py-3">
                  ...
                  <div className="d-flex align-items-center gap-15 flex-row align-items-center mt-2 mb-3">
